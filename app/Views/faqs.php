...
<body>
    ...
    <div class="p-5 mb-4 bg-light rounded-3">
        <div class="p-5 mb-10 bg-body-tertiary" style="background:url(https://c4.wallpaperflare.com/wallpaper/848/927/678/minimalism-texture-black-background-black-armor-wallpaper-preview.jpg)">
            ...
            <div class="row">
                <div class="col-md-12 my-2 card">
                    <div class="card-body">
                        ...
                        <p>(A) Kapan rilis untuk mangga Demon Slayer?
                        <p>
                    </div>
                </div>
            </div>
